...
Deze tabel is géén dataproduct.

=== Data deel fase
In de data deel fase wordt het statistische model uit de landelijke fase gebruikt om het uniforme overzicht te ontsluiten naar flexaanbieders en het geagregeerde uniforme overzicht als open dataproduct set aan te bieden op het Energiedata Portaal van EDSN.
...
Scenario - Geaggregeerd: {
  ...
  "DST" -> "DP": "1. Ontsluit uniforme overzicht"
  "Afn" -> "DP": "2. Vraag uniforme overzicht"
  "DP" -> "DP": "3. Aggregeer het uniforme overzicht"
  "DP" -> "Afn": "4. Lever uniforme overzich uit"
}
